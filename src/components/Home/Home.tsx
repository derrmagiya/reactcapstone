...
// Internal Imports
import fitness_image from '../../assets/Images/candra-winata-CYOFvtpOIpU-unsplash.jpg';
        ...
        <Root>
            ...
            <Main>
                <MainText>
                    ...
                    <Button color='primary' variant='contained' component={Link} to="/dashboard">See Your Fitness</Button>
                </MainText>
            </Main>
        </Root>
    )
